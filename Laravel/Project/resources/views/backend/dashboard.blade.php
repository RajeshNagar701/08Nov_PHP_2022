...
@section('main_container')
 ...
 <i class="fa  fa-pencil"></i><b>&nbsp;2,000 </b>Support Tickets Pending to Answere. nbsp;
    ...
    <script src="{{url('backend/assets/plugins/morris/raphael-2.1.0.min.js')}}"></script>
    <script src="{{url('backend/assets/plugins/morris/morris.js')}}"></script>
    <script src="{{url('backend/assets/scripts/dashboard-demo.js')}}"></script>
